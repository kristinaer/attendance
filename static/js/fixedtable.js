...
(function($) {
    ...
    function buildFixedColumns(src, section, cols, target) {
        ...
        if ($(section, src).length) {
            var colHead = $("<table class='table table-bordered' style='margin-bottom:0;'></table>").appendTo(target);
    ...
    function buildFixedTable(src, section, target) {
        if ($(section, src).length) {
            var th = $("<table class='table table-bordered' style='margin-bottom:0;'></table>").appendTo(target);
            var tr = null;
